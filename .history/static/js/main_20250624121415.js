...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const popupCloseBtn = document.querySelector('.homepopup-btn');
    ...
    if (popup && popupCloseBtn) {
        popupCloseBtn.addEventListener('click', function() {
            ...
            popup.style.transform = 'translate3d(-30px, -30px, 0)';
        ...
        console.warn('Popup elements not found - skipping popup animation');
    }

    // ===== OTHER FUNCTIONALITY =====
    // [Keep your other existing code here]
    // But wrap each section in null checks like:
