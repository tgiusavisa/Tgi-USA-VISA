...
document.addEventListener('DOMContentLoaded', function () {
    // Target the appointment form instead of .homepopup
    const appointmentForm = document.querySelector('.col-4.position-fixed');
    const closeBtn = document.querySelector('.homepopup-btn'); // Make sure this exists

    if (!appointmentForm || !closeBtn) {
    ...
    closeBtn.addEventListener('click', function () {
        ...
        void appointmentForm.offsetWidth;
        
        // Apply transitions and transformations
        appointmentForm.style.transition = 'opacity 0.6s ease, transform 0.6s ease';
        appointmentForm.style.opacity = '0';
        appointmentForm.style.transform = 'translate3d(-30px, -30px, 0)';
