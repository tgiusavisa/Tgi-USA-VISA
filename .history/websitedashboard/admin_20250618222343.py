...
from .models import Details, AboutUs, OurMission, OurVision, OurGoals, Visa, Home, AboutUshome, OurMissionhome, OurVisionhome, OurGoalshome, faqshome, highlightshome, BookingDetail, Payment, policy, Visitor
